...
class GaussianDiffusion:
    ...
    def sample_from_img(
        ...
        final = {}
        for sample in self.sample_from_img_progressive(
            model, x_start, sample_distance, model_kwargs=model_kwargs
        ):
            final = sample
        return final["sample"]
    ...
    def ddim_sample_from_img_progressive(
        self,
        model: UNetModel,
        x_start: th.Tensor,
        sample_distance: Union[int, None] = None,
        clip_denoised: bool = True,
        denoised_fn: Union[callable, None] = None,
    ...
    def ddim_sample_from_img(
        ...
        final = {}
        for sample in self.ddim_sample_from_img_progressive(
            model=model,
            x_start=x_start,
